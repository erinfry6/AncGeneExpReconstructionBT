...
**This script simulates continuous character evolution on a phylogenetic Tree. Specifically, I will simulate gene expression evolution of 10,000 genes across the primate tree used in my ancestral gene expression reconstruction project.**
...
simulatevarietyofexp<-function(tree, rootvector, nsimul){
   ...
   for (i in 1:nsimul){
     simulationvar[,i]<-fastBM(tree,rootvector[i], bounds=c(0,Inf), internal=TRUE,sig2=1)
  }
